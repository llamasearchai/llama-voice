# Contributing to Llama Voice

Thank you for your interest in contributing to Llama Voice! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to Llama Voice:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llama-voice.git
   cd llama-voice
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llama-voice.git
   ```
...
By contributing to Llama Voice, you agree that your contributions will be licensed under the project's MIT License.
