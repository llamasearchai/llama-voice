...
class WatermarkDetector:
    ...
    def _load_model(self) -> None:
        ...
        if not self.use_mlx:
            self.logger.warning(
                "MLX not available. Basic detection methods will be used instead."
            )
            return
