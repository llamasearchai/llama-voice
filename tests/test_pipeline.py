...
class TestVoiceProcessor:
    ...
    def test_init(self, temp_cache_dir):
        ...
        assert (
            processor.anonymizer is None
        )  # Should be None since anonymization is disabled
        assert (
            processor.secure_enclave is None
        )  # Should be None since secure enclave is disabled
    ...
    @patch(
        "llama_voice.processor.secure_enclave.SecureEnclaveManager.store_sensitive_audio"
    )
